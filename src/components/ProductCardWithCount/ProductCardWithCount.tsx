    ...
    return (
        <Card className="card">
            ...
            <div style={{ position: "relative", top: "-30px" }}>
                {cnt != 0 ? <h4 className="cardStatusGreen" style={{ position: "relative", top: "0px" }}>в наличии</h4> : <h4 className="cardStatusRed" style={{ position: "relative", top: "0px" }}>раскупили</h4>}
